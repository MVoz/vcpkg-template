...
namespace vcpkg
{
                                                       ...
                                                       const std::string& prepend_to_path)
    {
        ...
        std::vector<std::wstring> env_wstrings = {
            ...
            L"NDK_ARCH",
            L"ANDROID_SYSROOT",
            // Enables detection of Intel CPP in CMake
            L"ICPP_COMPILER17",
            L"ICPP_COMPILER18",
            L"ICPP_COMPILER19",
            L"ICPP_COMPILER20",
            ...
            L"TARGET_ARCH",
            L"C_TARGET_ARCH",
            // Enables detection of Intel LIB in INCLUDE
            L"LIBPATH",
            L"LIB",
            L"INCLUDE",
            L"WINDOWS_SDK",
            ...
            L"INTEL_DEV_REDIST",
            L"ICCLIB",
            // Enables detection of GLOBAL Intel in CMake
            L"INTEL_ROOT",
            L"VNI_DIR",
            L"FNL_DIR",
            // Enables detection of PGI Env
            L"PGI",
            L"PGI_ROOT",
            // Enables detection of Other
            L"LD_LIBRARY_PATH",
            L"PKG_CONFIG_PATH",
            L"BIN_PATH",
            L"QT5_ROOT",
