...
#			set(ENV{FFLAGS} "$ENV{FFLAGS} /libs:static")
    ...
    if(CMAKE_CXX_COMPILER MATCHES "[Cc]lang")
        set(CMAKE_CXX_FLAGS " /DWIN32 /D_WINDOWS /W4 /WX- ${CHARSET_FLAG} /GR /EHsc ${VCPKG_CXX_FLAGS}" CACHE STRING "")
        set(CMAKE_C_FLAGS " /DWIN32 /D_WINDOWS /W4 /WX- ${CHARSET_FLAG} ${VCPKG_C_FLAGS}" CACHE STRING "")
    ...
    if(VCPKG_FORTRAN_ENABLED AND DEFINED VCPKG_FORTRAN_COMPILER AND VCPKG_FORTRAN_COMPILER STREQUAL GNU)
		...
		set(CMAKE_Fortran_FLAGS " ${CMAKE_Fortran_FLAGS} -mabi=ms ")
		
        if(VCPKG_TARGET_ARCHITECTURE STREQUAL "x86")
            set(CMAKE_Fortran_FLAGS " ${CMAKE_Fortran_FLAGS} -fno-underscoring -D_X86_=1 -Di386=1 -march=x86-64 -m32 ")
        elseif(VCPKG_TARGET_ARCHITECTURE STREQUAL "x64")
            set(CMAKE_Fortran_FLAGS " ${CMAKE_Fortran_FLAGS} -fno-underscoring -D_WIN64 -D_AMD64_ -DAMD64 ")
        endif()
...
#    set(CMAKE_CXX_FLAGS " /guard:cf- /analyze- /nologo /openmp /DWIN32 /D_WINDOWS /W4 /WX- /bigobj /GR /EHsc /MP ${VCPKG_CXX_FLAGS}" CACHE STRING "")
#    set(CMAKE_C_FLAGS " /guard:cf- /analyze- /nologo /openmp /DWIN32 /D_WINDOWS /W4 /WX- /bigobj /GR- /EHsc /MP ${VCPKG_C_FLAGS}" CACHE STRING "")
...
#error #elif defined(__x86_64__) || defined(__amd64__) /D_WIN32 #LINUX /D_AMD64_ /D__x86_64__ 
        ...
        set(CMAKE_CXX_FLAGS " /nologo /DWIN32 /D_WINDOWS /WX- /W4 ${CHARSET_FLAG} /GR /EHsc /MP ${VCPKG_CXX_FLAGS}" CACHE STRING "")
        set(CMAKE_C_FLAGS " /nologo /DWIN32 /D_WINDOWS /WX- /W4 ${CHARSET_FLAG} /MP ${VCPKG_C_FLAGS}" CACHE STRING "")

        set(CMAKE_RC_FLAGS " -c65001 /DWIN32 /D_WIN32 ${CMAKE_RC_FLAGS} " CACHE STRING "")
...
#      add_definitions("-DINTEGER8 -D_FILE_OFFSET_BITS=64")
#      if(${CMAKE_C_COMPILER_ID} STREQUAL "GNU")
#        set(I8_FLAGS "-fdefault-integer-8")
#      elseif(${CMAKE_C_COMPILER_ID} STREQUAL "Intel")
#        set(I8_FLAGS "-i8" "-real_size:64")
