...
function(vcpkg_install_msbuild)
    ...
    set(ENV{_CL_} "/Z7 /W4 /WX- /FS /MP${VCPKG_CONCURRENCY}")
...
#        /m:1
#        /p:AdditionalIncludeDirectories="$ENV{IncludePath};"
#        /p:AdditionalLibraryDirectories="$ENV{LibPath};"
#        /p:IncludePath="${CURRENT_INSTALLED_DIR}/include;"
#        /p:LibraryPath="${CURRENT_INSTALLED_DIR}/lib;"
        /m
#        /nr:true
#        /warnasmessage:MSB4011
#        /nowarn:msb4011 ## MSBuild ver. 15.3++
    )
    if(VS_PLATFORM_TOOLSET MATCHES "WindowsDriverKit")
      list(APPEND _csc_OPTIONS
        "/p:BasePlatformToolset=${_csc_PLATFORM_TOOLSET}"
#        "/p:PlatformToolset=WindowsUserModeDriver10.0" OR WindowsKernelModeDriver10.0 OR WindowsApplicationForDrivers10.0 ###in PORTFILE.CMAKE file 
#        "/p:TreatWarningsAsErrors=false"
#        "/p:CompilerOptions
#        "/p:WarningLevel
        "/p:SpectreMitigation=false"
#        "/P:VCTargetsPath=${_csc_VS_PLATFORM_TOOLSET_VCTARGETS_CUSTOM_DIR}"
#        "/P:VCTargetsPath=${DOWNLOADS}/tools/VCTargetsPath/Microsoft/VC/v160" #repeat test ;((
      )
    elseif(VS_PLATFORM_TOOLSET MATCHES "Clang")
      list(APPEND _csc_OPTIONS
        "/p:BasePlatformToolset=${_csc_PLATFORM_TOOLSET}"
...
#            "/p:ForceImportBeforeCppProps=${SCRIPTS}/buildsystems/msbuild/user.vcpkg.props"
            "/p:VcpkgApplocalDeps=false"
#            "/p:VcpkgApplocalDeps=true"
#            "/p:VcpkgTriplet=${TARGET_TRIPLET}"#duble
#            "/p:VcpkgCurrentInstalledDir=${CURRENT_INSTALLED_DIR}"#duble
            )
    endif()
    ...
    if(NOT DEFINED VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL "release")
        ...
        list(FILTER LIBS EXCLUDE REGEX "/packages|/.build")
        file(GLOB_RECURSE DLLS ${PREBUILT}/*.dll)
        list(FILTER DLLS EXCLUDE REGEX "/packages|/.build")
#        list(REMOVE_ITEM DLLS "/packages|/.build")
        file(GLOB_RECURSE EXES ${PREBUILT}/*.exe)
        list(FILTER EXES EXCLUDE REGEX "/packages|/.build")
