...
function(vcpkg_build_cmake)
    ...
    if(_VCPKG_CMAKE_GENERATOR MATCHES "Ninja")
        ...
        set(BUILD_ARGS "-wdupbuild=warn") #  output
    ...
    elseif(_VCPKG_CMAKE_GENERATOR MATCHES "Visual Studio")
        ...
        elseif(DEFINED _bc_VS_PLATFORM_TOOLSET)
...
#        if(VCPKG_Fortran_IS_INTEL)
        elseif(DEFINED VCPKG_FORTRAN_COMPILER AND "${VCPKG_FORTRAN_COMPILER}" MATCHES "ifort")
    ...
    elseif(_VCPKG_CMAKE_GENERATOR MATCHES "MSYS Makefiles")
        set(BUILD_ARGS
            --keep-going -j4 
        )
        set(NO_PARALLEL_ARG
    ...
    foreach(BUILDTYPE "debug" "release")
        if(NOT DEFINED VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL BUILDTYPE)
            ...
            if(_bc_ADD_BIN_TO_PATH)
                ...
                if(BUILDTYPE STREQUAL "debug")
                    vcpkg_add_to_path(PREPEND "${CURRENT_INSTALLED_DIR}/debug/bin${_PATHSEP}$ENV{PATH}")
                else()
                    vcpkg_add_to_path(PREPEND "${CURRENT_INSTALLED_DIR}/bin${_PATHSEP}$ENV{PATH}")
                endif()
            endif()
