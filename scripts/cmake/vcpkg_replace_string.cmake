...
## find_library (PETSC_LIBRARY_${suffix} NAMES ${libname} HINTS ${petsc_lib_dir} NO_DEFAULT_PATH)
    ...
    function(CONVERT_CYGWIN_PATH PATH RESULT)
      file(TO_CMAKE_PATH ${PATH} CP)								# changes \ to / on windows
      string(REGEX REPLACE "^([a-zA-Z]):/" "/\\1/" CP2 ${CP})   	# c:/ -> /c/
	  set(${RESULT} "${CP2}" PARENT_SCOPE) 				        ### /c/ -> /cygdrive/c/  # or set(${RESULT} "/cygdrive${CP2}" PARENT_SCOPE)
    endfunction()

#    if (WIN32)
#	     find_program(CYGPATH_EXECUTABLE cygpath)
#        find_program(_cygpath_exe cygpath NO_CMAKE_ENVIRONMENT_PATH)
#        if(_cygpath_exe)
...
#	    message(${${_path}})
#       EXECUTE_PROCESS(COMMAND ${CYGPATH_EXECUTABLE} -up "${${_path}}"
