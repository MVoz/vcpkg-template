...
function(vcpkg_configure_cmake)
    cmake_parse_arguments(_csc
        "PREFER_NINJA;DISABLE_PARALLEL_CONFIGURE;NO_CHARSET_FLAG;ENABLE_Fortran_GNU"
...
#        list(APPEND _csc_OPTIONS -DBUILD_STATIC_BIN=ON -DBUILD_BOTH_STATIC_SHARED_LIB=ON -DBUILD_STATIC_CRT_LIBS=ON -DBUILD_STATIC=ON -DENABLE_STATIC=ON -DBUILD_SHARED=OFF )
    ...
    if(NOT VCPKG_CHAINLOAD_TOOLCHAIN_FILE)
        if(NOT DEFINED VCPKG_CMAKE_SYSTEM_NAME OR _TARGETTING_UWP)
            if(_csc_ENABLE_Fortran_GNU AND CMAKE_HOST_WIN32 AND NOT VCPKG_USE_EXTERNAL_Fortran)
...
#                                         "-DCMAKE_LINKER=link")
        ...
        elseif(VCPKG_CMAKE_SYSTEM_NAME STREQUAL "MSYS")
            set(VCPKG_CHAINLOAD_TOOLCHAIN_FILE "${SCRIPTS}/toolchains/msys64.cmake")
        elseif(VCPKG_CMAKE_SYSTEM_NAME STREQUAL "MipsEL")
            set(VCPKG_CHAINLOAD_TOOLCHAIN_FILE "${SCRIPTS}/toolchains/mips32r2.cmake")
        endif()
    endif()
...
#        "-DVS_PLATFORM_TOOLSET=${VS_PLATFORM_TOOLSET}"		
...
#        "-DCMAKE_VS_PLATFORM_TOOLSET=${VS_PLATFORM_TOOLSET}"
#        "-DVCPKG_FORTRAN_COMPILER=${VCPKG_FORTRAN_COMPILER}"
        "-DVCPKG_FORTRAN_ENABLED=${VCPKG_FORTRAN_ENABLED}"
#        "-DVCPKG_FORTRAN_TOOLSET_VERSION=${VCPKG_FORTRAN_TOOLSET_VERSION}"
#        "-DCMAKE_EXPORT_NO_PACKAGE_REGISTRY=ON"
#        "-DCMAKE_FIND_PACKAGE_NO_PACKAGE_REGISTRY=ON"
#        "-DCMAKE_FIND_PACKAGE_NO_SYSTEM_PACKAGE_REGISTRY=ON"
#        "-DCMAKE_INSTALL_SYSTEM_RUNTIME_LIBS_SKIP=TRUE"
    ...
    if(NOT PREFER_NINJA AND GENERATOR MATCHES "Visual Studio" AND DEFINED VS_PLATFORM_TOOLSET)
...
#            message(FATAL_ERROR "All three variables VCPKG_C_COMPILER, VCPKG_CXX_COMPILER and VCPKG_LINKER must be set for target Windows.")
#        endif()
#        if(NOT VCPKG_SKIP_AUTOMATIC_COMPILER_DETECTION AND (NOT VCPKG_C_COMPILER OR NOT VCPKG_CXX_COMPILER OR NOT VCPKG_LINKER))
...
#            set(ENV{NINJA_STATUS} "[%s/%t] ")
            execute_process(
                ...
                COMMAND ${dbg_command}
                WORKING_DIRECTORY ${CURRENT_BUILDTREES_DIR}/${TARGET_TRIPLET}-dbg
                RESULT_VARIABLE config-${TARGET_TRIPLET}-dbg
            )
        endif()
