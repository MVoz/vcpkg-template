...
elseif(CMAKE_SYSTEM_NAME STREQUAL "MinGW" OR (NOT CMAKE_SYSTEM_NAME AND CMAKE_HOST_SYSTEM_NAME STREQUAL "MinGW"))
    set(_VCPKG_TARGET_TRIPLET_PLAT MinGW)
elseif(CMAKE_SYSTEM_NAME STREQUAL "MSYS" OR (NOT CMAKE_SYSTEM_NAME AND CMAKE_HOST_SYSTEM_NAME STREQUAL "MSYS"))
    set(_VCPKG_TARGET_TRIPLET_PLAT MSYS)
elseif(CMAKE_SYSTEM_NAME STREQUAL "Linux" OR (NOT CMAKE_SYSTEM_NAME AND CMAKE_HOST_SYSTEM_NAME STREQUAL "Linux"))
    set(_VCPKG_TARGET_TRIPLET_PLAT "MIPSEL")
endif()
...
#set(MSYS_ROOT
#    I:\\msys2
#    ${_VCPKG_ROOT_DIR}/downloads/tools/msys2/msys64
#    ${_VCPKG_ROOT_DIR}/downloads/tools/msys2/msys32
#)
...
#file(TO_CMAKE_PATH "$ENV{MSYS_ROOT}" _msys)
...
#        set_target_properties(${name} PROPERTIES VS_USER_PROPS do_not_import_user.props)
#        set_target_properties(${name} PROPERTIES VS_USER_PROPS import_user.props)

#        set_target_properties(${name} PROPERTIES VS_CUSTOM_TARGETS import_custom.targets)
#        set_target_properties(${name} PROPERTIES VS_CUSTOM_TARGETS "$(MSBuildExtensionsPath)\\.targets")
#        set_target_properties(${name} PROPERTIES VS_CUSTOM_TARGETS "$(VCTargetsPath)\\Platforms\\x64\\PlatformToolsets\\Intel C++ Compiler 19.0\\Toolset.targets")
#        set_target_properties(${name} PROPERTIES VS_PROPERTY_SHEETS "$(VCTargetsPath)\\Platforms\\x64\\PlatformToolsets\\Intel C++ Compiler 19.0\\Toolset.props")

#        set_target_properties(${name} PROPERTIES VS_GLOBAL_VcpkgEnabled false)
#        set_target_properties(${name} PROPERTIES VS_GLOBAL_VcpkgEnabled true)
#        set_target_properties(${name} PROPERTIES VS_GLOBAL_VcpkgTriplet ${VCPKG_TARGET_TRIPLET})
    endif()
endfunction()

# About to perform deeply recursive actions
#if(NOT CMAKE_MAXIMUM_RECURSION_DEPTH)
#  set(CMAKE_MAXIMUM_RECURSION_DEPTH 320401)
#endif()

#if(NOT CMAKE_MAXIMUM_RECURSION_DEPTH)
#  set(CMAKE_MAXIMUM_RECURSION_DEPTH 10000)
#elseif(MINGW)
