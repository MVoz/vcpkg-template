...
# vcpkg_fail_port_install(MESSAGE "penf currently only supports Linux and Mac platforms" ON_TARGET "Windows")
...
#git diff > ..\..\..\..\ports\penf\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\penf\001_penf_patch.patch
...
vcpkg_download_distfile(ARCHIVE
    URLS "https://gitlab.com/fempar/PENF/-/archive/d69e828de3777d0cf874c1ac9db123a69acab89c/PENF-d69e828de3777d0cf874c1ac9db123a69acab89c.tar.gz"
    FILENAME "PENF-d69e828de3777d0cf874c1ac9db123a69acab89c.tar.gz"
    SHA512 5cc19b0c310c56239c5f62a9d9406f2267f9b291cdf6823ae23a9950b70e78b41956dc4e339c5b5fd0d3d3f2f8e3eae922b3b7dd412af0522e6b91f4758f2daa
)
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_penf_fixes.patch
#      001_penf_patch.patch
)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/penf RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME penf)
...
# # Moves all .cmake files from /debug/share/penf/ to /share/penf/
# # See /docs/maintainers/vcpkg_fixup_cmake_targets.md for more details
# vcpkg_fixup_cmake_targets(CONFIG_PATH cmake TARGET_PATH share/penf)
