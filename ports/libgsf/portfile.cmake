...
# vcpkg_fail_port_install(MESSAGE "libgsf currently only supports Linux and Mac platforms" ON_TARGET "Windows")
...
#git diff > ..\..\..\..\ports\libgsf\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\libgsf\001_libgsf_patch.patch
...
set(GIT_URL "https://gitlab.gnome.org/GNOME/libgsf")
set(GIT_REV master)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/libgsf RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME libgsf)
...
# # Moves all .cmake files from /debug/share/libgsf/ to /share/libgsf/
# # See /docs/maintainers/vcpkg_fixup_cmake_targets.md for more details
# vcpkg_fixup_cmake_targets(CONFIG_PATH cmake TARGET_PATH share/libgsf)
