...
# vcpkg_fail_port_install(MESSAGE "vala currently only supports Linux and Mac platforms" ON_TARGET "Windows")
...
#git diff > ..\..\..\..\ports\vala\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\vala\001_vala_patch.patch
...
vcpkg_download_distfile(ARCHIVE
    URLS "https://download.gnome.org/sources/vala/0.48/vala-0.48.1.tar.xz"
    FILENAME "vala-0.48.1.tar.xz"
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_vala_fixes.patch
#      001_vala_patch.patch
)
...
# # Moves all .cmake files from /debug/share/vala/ to /share/vala/
# # See /docs/maintainers/vcpkg_fixup_cmake_targets.md for more details
# vcpkg_fixup_cmake_targets(CONFIG_PATH cmake TARGET_PATH share/vala)
