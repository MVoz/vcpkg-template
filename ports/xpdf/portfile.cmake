...
# vcpkg_fail_port_install(MESSAGE "xpdf currently only supports Linux and Mac platforms" ON_TARGET "Windows")
...
#git diff > ..\..\..\..\ports\xpdf\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\xpdf\001_xpdf_patch.patch
...
vcpkg_download_distfile(ARCHIVE
    URLS "https://xpdfreader-dl.s3.amazonaws.com/xpdf-4.02.tar.gz"
    FILENAME "xpdf-4.02.tar.gz"
    SHA512 72c9413fc7241dde5288137ca8a68c837d2a68e95e909dbe2afe8f374b5a7c92af4edf82918963d1c6388c947057fcf5f0ae1e6fbb2b31c3d5eb9a07d3c74ddc
)
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_xpdf_fixes.patch
#      001_xpdf_patch.patch
)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/xpdf RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME xpdf)
...
# # Moves all .cmake files from /debug/share/xpdf/ to /share/xpdf/
# # See /docs/maintainers/vcpkg_fixup_cmake_targets.md for more details
# vcpkg_fixup_cmake_targets(CONFIG_PATH cmake TARGET_PATH share/xpdf)
