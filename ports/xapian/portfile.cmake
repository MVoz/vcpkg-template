...
# vcpkg_fail_port_install(MESSAGE "xapian currently only supports Linux and Mac platforms" ON_TARGET "Windows")
...
#git diff > ..\..\..\..\ports\xapian\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\xapian\001_xapian_patch.patch
...
set(GIT_URL "https://github.com/xapian/xapian")
set(GIT_REV master)
...
#        PRERUN_SHELL ${SOURCE_PATH}/bootstrap
        PRERUN_SHELL ${SOURCE_PATH}/xapian-core/preautoreconf
        PROJECT_SUBPATH xapian-core
        COPY_SOURCE
#        SKIP_CONFIGURE
#        OPTIONS
...
# # Moves all .cmake files from /debug/share/xapian/ to /share/xapian/
# # See /docs/maintainers/vcpkg_fixup_cmake_targets.md for more details
# vcpkg_fixup_cmake_targets(CONFIG_PATH cmake TARGET_PATH share/xapian)
