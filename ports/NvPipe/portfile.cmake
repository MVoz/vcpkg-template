...
# vcpkg_fail_port_install(MESSAGE "NvPipe currently only supports Linux and Mac platforms" ON_TARGET "Windows")
...
#git diff > ..\..\..\..\ports\NvPipe\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\NvPipe\001_NvPipe_patch.patch
...
vcpkg_download_distfile(ARCHIVE
    URLS "https://github.com/NVIDIA/NvPipe/archive/1656d1b435b43bdf1f74b63cffed393ca9ea3875.zip"
    FILENAME "1656d1b435b43bdf1f74b63cffed393ca9ea3875.zip"
    SHA512 fd0fe2e5815101e253b6b2424fb3e6dbf3f66c51b9d5615e91452f76d7e47dec3f0ef9268026a1ea8c39709d7b66cae1a9fb967979a9ed80d52c4644e5a8711a
)
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_NvPipe_fixes.patch
#      001_NvPipe_patch.patch
)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/NvPipe RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME NvPipe)
...
# # Moves all .cmake files from /debug/share/NvPipe/ to /share/NvPipe/
# # See /docs/maintainers/vcpkg_fixup_cmake_targets.md for more details
# vcpkg_fixup_cmake_targets(CONFIG_PATH cmake TARGET_PATH share/NvPipe)
