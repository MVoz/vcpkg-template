...
# vcpkg_fail_port_install(MESSAGE "openvkl currently only supports Linux and Mac platforms" ON_TARGET "Windows")
...
#git diff > ..\..\..\..\ports\openvkl\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\openvkl\001_openvkl_patch.patch
...
set(GIT_URL "https://github.com/openvkl/openvkl")
set(GIT_REV master)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/openvkl RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME openvkl)
...
# # Moves all .cmake files from /debug/share/openvkl/ to /share/openvkl/
# # See /docs/maintainers/vcpkg_fixup_cmake_targets.md for more details
# vcpkg_fixup_cmake_targets(CONFIG_PATH cmake TARGET_PATH share/openvkl)
