...
# vcpkg_fail_port_install(MESSAGE "ospcommon currently only supports Linux and Mac platforms" ON_TARGET "Windows")
...
#git diff > ..\..\..\..\ports\ospcommon\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\ospcommon\001_ospcommon_patch.patch
...
vcpkg_download_distfile(ARCHIVE
    URLS "https://github.com/ospray/ospcommon/archive/v1.2.0.tar.gz"
    FILENAME "ospcommon-v1.2.0.tar.gz"
    SHA512 63360923e1d96a6b8295dc56939102686e3347d4aa9dca8235077ef68f14be7d1ae217b5ba360dbc4e458dfe5078cee03b839aea8ce2b536dca9987411532ff5
)
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_ospcommon_fixes.patch
#      001_ospcommon_patch.patch
)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/ospcommon RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME ospcommon)
...
# # Moves all .cmake files from /debug/share/ospcommon/ to /share/ospcommon/
# # See /docs/maintainers/vcpkg_fixup_cmake_targets.md for more details
# vcpkg_fixup_cmake_targets(CONFIG_PATH cmake TARGET_PATH share/ospcommon)
