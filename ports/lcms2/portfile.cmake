...
# vcpkg_fail_port_install(MESSAGE "lcms2 currently only supports Linux and Mac platforms" ON_TARGET "Windows")
...
#git diff > ..\..\..\..\ports\lcms2\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\lcms2\001_lcms2_patch.patch
...
vcpkg_download_distfile(ARCHIVE
    URLS "https://xpdfreader-dl.s3.amazonaws.com/lcms2-2.9.tar.gz"
    FILENAME "lcms2-2.9.tar.gz"
    SHA512 70b1c51fa8d137d5072425e580745ff1fbf49c6e8bb1da0a8adb0647d3b7c095208793cb02de1e8d1a01363b8575fa60c61bedbff99bbec57a44228239cb00e5
)
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_lcms2_fixes.patch
#      001_lcms2_patch.patch
)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/lcms2 RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME lcms2)
...
# # Moves all .cmake files from /debug/share/lcms2/ to /share/lcms2/
# # See /docs/maintainers/vcpkg_fixup_cmake_targets.md for more details
# vcpkg_fixup_cmake_targets(CONFIG_PATH cmake TARGET_PATH share/lcms2)
