...
# vcpkg_fail_port_install(MESSAGE "antioch currently only supports Linux and Mac platforms" ON_TARGET "Windows")
...
#git diff > ..\..\..\..\ports\antioch\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\antioch\001_antioch_patch.patch
...
#      "--with-boost-lib=${CURRENT_INSTALLED_DIR}/debug/lib"
      "--with-boost='\${prefix}'/debug/lib"
#	  "--exec_prefix=${prefix}"
#      --enable-strip
#      --disable-lavf
#      --disable-swscale
    OPTIONS_RELEASE
#      "--with-boost-lib=${CURRENT_INSTALLED_DIR}/lib"
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/antioch RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME antioch)
...
# # Moves all .cmake files from /debug/share/antioch/ to /share/antioch/
# # See /docs/maintainers/vcpkg_fixup_cmake_targets.md for more details
# vcpkg_fixup_cmake_targets(CONFIG_PATH cmake TARGET_PATH share/antioch)
