...
# vcpkg_fail_port_install(MESSAGE "fort currently only supports Linux and Mac platforms" ON_TARGET "Windows")
...
#git diff > ..\..\..\..\ports\fort\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\fort\001_fort_patch.patch
...
vcpkg_download_distfile(ARCHIVE
    URLS "https://github.com/llvm-fortran/fort/archive/8.0.0.tar.gz"
    FILENAME "8.0.0.tar.gz"
    SHA512 3b9233c9491ac06e0a4041d9b895e3de89947584bf94b1d8483f48872215ded7f66be8b55e330a933a35b28e1985bd8e7914924de1d747319a5e3129648f9da1
)
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_fort_fixes.patch
#      001_fort_patch.patch
)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/fort RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME fort)
...
# # Moves all .cmake files from /debug/share/fort/ to /share/fort/
# # See /docs/maintainers/vcpkg_fixup_cmake_targets.md for more details
# vcpkg_fixup_cmake_targets(CONFIG_PATH cmake TARGET_PATH share/fort)
