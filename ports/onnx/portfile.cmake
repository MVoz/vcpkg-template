...
# vcpkg_fail_port_install(MESSAGE "onnx currently only supports Linux and Mac platforms" ON_TARGET "Windows")
...
#git diff > ..\..\..\..\ports\onnx\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\onnx\001_onnx_patch.patch
...
set(GIT_URL "https://github.com/onnx/onnx")
set(GIT_REV master)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/onnx RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME onnx)
...
# # Moves all .cmake files from /debug/share/onnx/ to /share/onnx/
# # See /docs/maintainers/vcpkg_fixup_cmake_targets.md for more details
# vcpkg_fixup_cmake_targets(CONFIG_PATH cmake TARGET_PATH share/onnx)
