...
# vcpkg_fail_port_install(MESSAGE "oidn currently only supports Linux and Mac platforms" ON_TARGET "Windows")
...
#git diff > ..\..\..\..\ports\oidn\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\oidn\001_oidn_patch.patch
...
set(GIT_URL "https://github.com/OpenImageDenoise/oidn")
set(GIT_REV master)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/oidn RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME oidn)
...
# # Moves all .cmake files from /debug/share/oidn/ to /share/oidn/
# # See /docs/maintainers/vcpkg_fixup_cmake_targets.md for more details
# vcpkg_fixup_cmake_targets(CONFIG_PATH cmake TARGET_PATH share/oidn)
