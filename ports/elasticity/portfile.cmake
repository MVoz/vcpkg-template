...
# vcpkg_fail_port_install(MESSAGE "elasticity currently only supports Linux and Mac platforms" ON_TARGET "Windows")
...
#git diff > ..\..\..\..\ports\elasticity\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\elasticity\001_elasticity_patch.patch
...
vcpkg_download_distfile(ARCHIVE
    URLS "https://github.com/ISCDtoolbox/LinearElasticity/archive/2170f6454e68f7c04fa17531bb94e31e0465c89d.zip"
    FILENAME "2170f6454e68f7c04fa17531bb94e31e0465c89d.zip"
    SHA512 8eaa7f408b2768c26ab84056319fa945e216e23c3e9a2ac964b0253e8658d024ed9ec512a7a4ed96c6e25de2d85de06a7f44b187f8343457bbc09964760955e6
)
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_elasticity_fixes.patch
#      001_elasticity_patch.patch
)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/elasticity RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME elasticity)
...
# # Moves all .cmake files from /debug/share/elasticity/ to /share/elasticity/
# # See /docs/maintainers/vcpkg_fixup_cmake_targets.md for more details
# vcpkg_fixup_cmake_targets(CONFIG_PATH cmake TARGET_PATH share/elasticity)
