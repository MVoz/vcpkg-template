...
file(GLOB DLL_D_FILES ${CURRENT_PACKAGES_DIR}/debug/lib/*.dll)
file(COPY ${DLL_FILES} DESTINATION ${CURRENT_PACKAGES_DIR}/bin)
file(COPY ${DLL_D_FILES} DESTINATION ${CURRENT_PACKAGES_DIR}/debug/bin)
file(REMOVE_RECURSE ${CURRENT_PACKAGES_DIR}/debug/share ${CURRENT_PACKAGES_DIR}/debug/include ${DLL_FILES} ${DLL_D_FILES})
