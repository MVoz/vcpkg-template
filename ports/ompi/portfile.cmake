...
# vcpkg_fail_port_install(MESSAGE "ompi currently only supports Linux and Mac platforms" ON_TARGET "Windows")
...
#git diff > ..\..\..\..\ports\ompi\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\ompi\001_ompi_patch.patch
...
set(GIT_URL "https://github.com/open-mpi/ompi")
set(GIT_REV master)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/ompi RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME ompi)
...
# # Moves all .cmake files from /debug/share/ompi/ to /share/ompi/
# # See /docs/maintainers/vcpkg_fixup_cmake_targets.md for more details
# vcpkg_fixup_cmake_targets(CONFIG_PATH cmake TARGET_PATH share/ompi)
