...
# vcpkg_fail_port_install(MESSAGE "cppdb currently only supports Linux and Mac platforms" ON_TARGET "Windows")
...
#git diff > ..\..\..\..\ports\cppdb\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\cppdb\001_cppdb_patch.patch
...
vcpkg_download_distfile(ARCHIVE
    URLS "https://sourceforge.net/projects/cppcms/files/cppdb/0.3.1/cppdb-0.3.1.tar.bz2/download"
    FILENAME "download"
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_cppdb_fixes.patch
#      001_cppdb_patch.patch
)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/cppdb RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME cppdb)
...
# # Moves all .cmake files from /debug/share/cppdb/ to /share/cppdb/
# # See /docs/maintainers/vcpkg_fixup_cmake_targets.md for more details
# vcpkg_fixup_cmake_targets(CONFIG_PATH cmake TARGET_PATH share/cppdb)
