...
# vcpkg_fail_port_install(MESSAGE "gtk-doc currently only supports Linux and Mac platforms" ON_TARGET "Windows")
...
#git diff > ..\..\..\..\ports\gtk-doc\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\gtk-doc\001_gtk-doc_patch.patch
...
set(GIT_URL "https://gitlab.gnome.org/GNOME/gtk-doc")
set(GIT_REV master)
...
#  RELEASE_FILES ${CURRENT_INSTALLED_DIR}#/lib/pkgconfig
#  DEBUG_FILES ${CURRENT_INSTALLED_DIR}/debug#/lib/pkgconfig
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/gtk-doc RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME gtk-doc)
