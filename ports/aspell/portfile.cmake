...
# vcpkg_fail_port_install(MESSAGE "aspell currently only supports Linux and Mac platforms" ON_TARGET "Windows")
...
#git diff > ..\..\..\..\ports\aspell\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\aspell\001_aspell_patch.patch
...
vcpkg_download_distfile(ARCHIVE
    URLS "https://alpha.gnu.org/gnu/aspell/aspell-0.60.8-20190923.tar.gz"
    FILENAME "aspell-0.60.8-20190923.tar.gz"
    SHA512 23eda81afe408f0e50c3c969230bf517b96b3675dc73feb46670746df9969f58bdf8b845b471ccfc173d4df06543c31480e533c8e526a03131107e015f7d1367
)
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_aspell_fixes.patch
#      001_aspell_patch.patch
)

find_program(GIT NAMES git git.cmd)
set(GIT_URL "https://alpha.gnu.org/gnu/aspell/aspell-0.60.8-20190923.tar.gz")
set(GIT_REV master)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/aspell RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME aspell)
...
# # Moves all .cmake files from /debug/share/aspell/ to /share/aspell/
# # See /docs/maintainers/vcpkg_fixup_cmake_targets.md for more details
# vcpkg_fixup_cmake_targets(CONFIG_PATH cmake TARGET_PATH share/aspell)
