...
# vcpkg_fail_port_install(MESSAGE "glpk currently only supports Linux and Mac platforms" ON_TARGET "Windows")
...
#git diff > ..\..\..\..\ports\glpk\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\glpk\001_glpk_patch.patch
...
vcpkg_download_distfile(ARCHIVE
    URLS "https://ftp.gnu.org/gnu/glpk/glpk-4.65.tar.gz"
    FILENAME "glpk-4.65.tar.gz"
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_glpk_fixes.patch
#      001_glpk_patch.patch
)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/glpk RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME glpk)
...
# # Moves all .cmake files from /debug/share/glpk/ to /share/glpk/
# # See /docs/maintainers/vcpkg_fixup_cmake_targets.md for more details
# vcpkg_fixup_cmake_targets(CONFIG_PATH cmake TARGET_PATH share/glpk)
