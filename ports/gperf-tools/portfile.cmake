...
# vcpkg_fail_port_install(MESSAGE "gperf-tools currently only supports Linux and Mac platforms" ON_TARGET "Windows")
...
#git diff > ..\..\..\..\ports\gperf-tools\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\gperf-tools\001_gperf-tools_patch.patch
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_gperf-tools_fixes.patch
#      001_gperf-tools_patch.patch
)
...
vcpkg_configure_make(
        ...
        COPY_SOURCE
#        OPTIONS
#          "--enable-doc=no"#        use gtk-doc to build documentation [[default=no]]
#          "CL_PROG_INSTALL=${SOURCE_PATH}/build-aux/install-sh"
#          "--enable-doc-html=no"#   build documentation in html format [[default=yes]]
#          "--enable-doc-pdf=no"#          CONFIGOPTS="--disable-documentation"
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/gperf-tools RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME gperf-tools)
...
# # Moves all .cmake files from /debug/share/gperf-tools/ to /share/gperf-tools/
# # See /docs/maintainers/vcpkg_fixup_cmake_targets.md for more details
# vcpkg_fixup_cmake_targets(CONFIG_PATH cmake TARGET_PATH share/gperf-tools)
