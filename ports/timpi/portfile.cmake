...
# vcpkg_fail_port_install(MESSAGE "timpi currently only supports Linux and Mac platforms" ON_TARGET "Windows")
...
#git diff > ..\..\..\..\ports\timpi\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\timpi\001_timpi_patch.patch
...
set(GIT_URL "https://github.com/libMesh/TIMPI")
set(GIT_REV master)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/timpi RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME timpi)
...
# # Moves all .cmake files from /debug/share/timpi/ to /share/timpi/
# # See /docs/maintainers/vcpkg_fixup_cmake_targets.md for more details
# vcpkg_fixup_cmake_targets(CONFIG_PATH cmake TARGET_PATH share/timpi)
