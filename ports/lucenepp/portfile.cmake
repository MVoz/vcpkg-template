...
# vcpkg_fail_port_install(MESSAGE "lucenepp currently only supports Linux and Mac platforms" ON_TARGET "Windows")
...
#git diff > ..\..\..\..\ports\lucenepp\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\lucenepp\001_lucenepp_patch.patch
...
vcpkg_download_distfile(ARCHIVE
    URLS "https://github.com/luceneplusplus/LucenePlusPlus/archive/692390d6ceb2ddaa34e4e4f3b9e409e155769b81.zip"
    FILENAME "692390d6ceb2ddaa34e4e4f3b9e409e155769b81.zip"
    SHA512 00b09b7766f8c60eec8839f577e6740179d7e3368160819902e07e24f2b30d369e47b62c1c0a74e616b311fe28a89ba34e5bd38e36a5c695ebf7a3a9c49101b2
)
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_lucenepp_fixes.patch
#      001_lucenepp_patch.patch
)
...
#      -D =OFF
    OPTIONS 
      -DENABLE_DEMO:BOOL=OFF
      -DENABLE_TEST:BOOL=OFF
      -DCOTIRE_VERBOSE:BOOL=ON
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/lucenepp RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME lucenepp)
...
# # Moves all .cmake files from /debug/share/lucenepp/ to /share/lucenepp/
# # See /docs/maintainers/vcpkg_fixup_cmake_targets.md for more details
# vcpkg_fixup_cmake_targets(CONFIG_PATH cmake TARGET_PATH share/lucenepp)
