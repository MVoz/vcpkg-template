...
# vcpkg_fail_port_install(MESSAGE "ospray currently only supports Linux and Mac platforms" ON_TARGET "Windows")
...
#git diff > ..\..\..\..\ports\ospray\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\ospray\001_ospray_patch.patch
...
vcpkg_download_distfile(ARCHIVE
    URLS "https://github.com/ospray/ospray/archive/v2.0.1.tar.gz"
    FILENAME "ospray-v2.0.1.tar.gz"
    SHA512 122aa1b104ee74757a11b2456fe6f1fc14a021e1ab4b4af7ccd068c4a46e74411d5cc09dfe5dea5d1dc38fc6fa0ad4962cf856e1cc5336880685b5de3c1cbc5b
)
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_ospray_fixes.patch
#      001_ospray_patch.patch
)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/ospray RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME ospray)
...
# # Moves all .cmake files from /debug/share/ospray/ to /share/ospray/
# # See /docs/maintainers/vcpkg_fixup_cmake_targets.md for more details
# vcpkg_fixup_cmake_targets(CONFIG_PATH cmake TARGET_PATH share/ospray)
