...
# vcpkg_fail_port_install(MESSAGE "pdfalto currently only supports Linux and Mac platforms" ON_TARGET "Windows")
...
#git diff > ..\..\..\..\ports\pdfalto\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\pdfalto\001_pdfalto_patch.patch
...
set(GIT_URL "https://github.com/kermitt2/pdfalto")
set(GIT_REV master)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/pdfalto RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME pdfalto)
...
# # Moves all .cmake files from /debug/share/pdfalto/ to /share/pdfalto/
# # See /docs/maintainers/vcpkg_fixup_cmake_targets.md for more details
# vcpkg_fixup_cmake_targets(CONFIG_PATH cmake TARGET_PATH share/pdfalto)
