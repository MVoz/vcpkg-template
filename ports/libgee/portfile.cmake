...
# vcpkg_fail_port_install(MESSAGE "libgee currently only supports Linux and Mac platforms" ON_TARGET "Windows")
...
#git diff > ..\..\..\..\ports\libgee\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\libgee\001_libgee_patch.patch
...
vcpkg_download_distfile(ARCHIVE
    URLS "https://download.gnome.org/sources/libgee/0.20/libgee-0.20.3.tar.xz"
    FILENAME "libgee-0.20.3.tar.xz"
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_libgee_fixes.patch
#      001_libgee_patch.patch
)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/libgee RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME libgee)
...
# # Moves all .cmake files from /debug/share/libgee/ to /share/libgee/
# # See /docs/maintainers/vcpkg_fixup_cmake_targets.md for more details
# vcpkg_fixup_cmake_targets(CONFIG_PATH cmake TARGET_PATH share/libgee)
