...
# vcpkg_fail_port_install(MESSAGE "hlsdl currently only supports Linux and Mac platforms" ON_TARGET "Windows")
...
#git diff > ..\..\..\..\ports\hlsdl\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\hlsdl\001_hlsdl_patch.patch
...
set(GIT_URL "https://github.com/selsta/hlsdl")
set(GIT_REV master)
...
vcpkg_install_msbuild(
    SOURCE_PATH ${SOURCE_PATH}
    PROJECT_SUBPATH "msvc/hlsdl.vcxproj"
#    TARGET Restore
    SKIP_CLEAN
...
#        "/p:ZLIB_INCLUDE_PATH="
#    OPTIONS_RELEASE /p:ZLIB_LIB=
#    OPTIONS_DEBUG /p:ZLIB_LIB=
    RELEASE_CONFIGURATION Release_MT
    DEBUG_CONFIGURATION Debug_MD
#    TARGET_PLATFORM_VERSION
#    TARGET
    LICENSE_SUBPATH LICENSE
#    INCLUDES_SUBPATH hidapi/include
...
# # Moves all .cmake files from /debug/share/hlsdl/ to /share/hlsdl/
# # See /docs/maintainers/vcpkg_fixup_cmake_targets.md for more details
# vcpkg_fixup_cmake_targets(CONFIG_PATH cmake TARGET_PATH share/hlsdl)
# file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/hlsdl RENAME copyright)

# # Post-build test for cmake libraries
# vcpkg_test_cmake(PACKAGE_NAME hlsdl)
