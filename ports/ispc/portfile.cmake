...
# vcpkg_fail_port_install(MESSAGE "ispc currently only supports Linux and Mac platforms" ON_TARGET "Windows")
...
#git diff > ..\..\..\..\ports\ispc\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\ispc\001_ispc_patch.patch
...
set(GIT_URL "https://github.com/ispc/ispc")
set(GIT_REV master)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/ispc RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME ispc)
...
# # Moves all .cmake files from /debug/share/ispc/ to /share/ispc/
# # See /docs/maintainers/vcpkg_fixup_cmake_targets.md for more details
# vcpkg_fixup_cmake_targets(CONFIG_PATH cmake TARGET_PATH share/ispc)
