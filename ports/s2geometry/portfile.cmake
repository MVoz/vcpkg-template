...
# vcpkg_fail_port_install(MESSAGE "s2geometry currently only supports Linux and Mac platforms" ON_TARGET "Windows")
...
#git diff > ..\..\..\..\ports\s2geometry\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\s2geometry\001_s2geometry_patch.patch
...
vcpkg_download_distfile(ARCHIVE
    URLS "https://github.com/google/s2geometry/archive/v0.9.0.tar.gz"
    FILENAME "v0.9.0.tar.gz"
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_s2geometry_fixes.patch
#      001_s2geometry_patch.patch
)
...
#      -D =OFF
    OPTIONS 
	  ...
	  -DWITH_GLOG=OFF
      -DBUILD_EXAMPLES=OFF
#      -DSWIG_DIR:PATH=E:/tools/swig/3.0.12/Lib
#      -DSWIG_EXECUTABLE:FILEPATH=E:/tools/swig/3.0.12/swig.exe

#      -DPYTHON_DEBUG_LIBRARY:FILEPATH=E:/tools/vcpkg/installed/x64-windows/debug/lib/python37_d.lib
#      -DPYTHON_EXECUTABLE:FILEPATH=E:/tools/python/python3/python3.7.exe
#      -DPYTHON_INCLUDE_DIR:PATH=E:/tools/vcpkg/installed/x64-windows/include/python3.7
#      -DPYTHON_LIBRARY:FILEPATH=E:/tools/vcpkg/installed/x64-windows/lib/python37.lib
...
# vcpkg_test_cmake(PACKAGE_NAME s2geometry)
...
# # Moves all .cmake files from /debug/share/s2geometry/ to /share/s2geometry/
# # See /docs/maintainers/vcpkg_fixup_cmake_targets.md for more details
# vcpkg_fixup_cmake_targets(CONFIG_PATH cmake TARGET_PATH share/s2geometry)
