...
#   CURRENT_PACKAGES_DIR      = ${VCPKG_ROOT_DIR}\packages\${PORT}_${TARGET_TRIPLET} CURRENT_INSTALLED_DIR
...
# vcpkg_fail_port_install(MESSAGE "pastix currently only supports Linux and Mac platforms" ON_TARGET "Windows")
...
#git diff > ..\..\..\..\ports\pastix\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\pastix\001_pastix_patch.patch
