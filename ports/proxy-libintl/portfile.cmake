...
# vcpkg_fail_port_install(MESSAGE "proxy-libintl currently only supports Linux and Mac platforms" ON_TARGET "Windows")
...
#git diff > ..\..\..\..\ports\proxy-libintl\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\proxy-libintl\001_proxy-libintl_patch.patch
...
set(GIT_URL "https://github.com/frida/proxy-libintl")
set(GIT_REV master)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/proxy-libintl RENAME copyright)
...
# # Moves all .cmake files from /debug/share/proxy-libintl/ to /share/proxy-libintl/
# # See /docs/maintainers/vcpkg_fixup_cmake_targets.md for more details
# vcpkg_fixup_cmake_targets(CONFIG_PATH cmake TARGET_PATH share/proxy-libintl)
