...
# vcpkg_fail_port_install(MESSAGE "pdf2xml currently only supports Linux and Mac platforms" ON_TARGET "Windows")
...
#git diff > ..\..\..\..\ports\pdf2xml\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\pdf2xml\001_pdf2xml_patch.patch
...
set(GIT_URL "https://github.com/kermitt2/pdf2xml")
set(GIT_REV master)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/pdf2xml RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME pdf2xml)
...
# # Moves all .cmake files from /debug/share/pdf2xml/ to /share/pdf2xml/
# # See /docs/maintainers/vcpkg_fixup_cmake_targets.md for more details
# vcpkg_fixup_cmake_targets(CONFIG_PATH cmake TARGET_PATH share/pdf2xml)
