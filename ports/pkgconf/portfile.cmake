...
# vcpkg_fail_port_install(MESSAGE "pkgconf currently only supports Linux and Mac platforms" ON_TARGET "Windows")
...
#git diff > ..\..\..\..\ports\pkgconf\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\pkgconf\001_pkgconf_patch.patch
...
vcpkg_download_distfile(ARCHIVE
    URLS "https://github.com/pkgconf/pkgconf/archive/pkgconf-1.6.3.tar.gz"
    FILENAME "pkgconf-1.6.3.tar.gz"
    SHA512 e5550b68939d6936afa957b0a0fb4bcb36731ad6b617199a720ce9d3f0e8a93c12df18a8192b3e7dff43dbb4c9a9ba7973e97c849d1f84653a4fb40ce20c6eb2
)
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_pkgconf_fixes.patch
#      001_pkgconf_patch.patch
)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/pkgconf RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME pkgconf)
...
# # Moves all .cmake files from /debug/share/pkgconf/ to /share/pkgconf/
# # See /docs/maintainers/vcpkg_fixup_cmake_targets.md for more details
# vcpkg_fixup_cmake_targets(CONFIG_PATH cmake TARGET_PATH share/pkgconf)
